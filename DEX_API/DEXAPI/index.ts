...
import { handleBotMessage } from './src/bot/shadowVaultBot'
...
const callChangeNow = async (attempt: ChangeNowAttempt) => {
...
const callChangeNowWithFallback = async (attempts: ChangeNowAttempt[]) => {
  const errors: string[] = []
