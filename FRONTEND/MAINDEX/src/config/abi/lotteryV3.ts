...
export const lotteryV3Abi = [
  ...
  },
  {
    ...
    name: 'NewOperatorAndTreasuryAddresses',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  {
    inputs: [],
    name: 'CancelLotteryAndWithdrawTokens',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
    ...
    outputs: [
      {
        ...
        internalType: 'struct MarSwapLottery.colInfo[]',
        name: 'collectionInfo',
        type: 'tuple[]',
      },
    ],
  ...
  },
  {
    ...
    name: 'getTotalNFTTicketsAvailable',
    outputs: [
      {
        internalType: 'uint256',
        name: '_total',
    ...
    outputs: [
      {
        components: [
          {
            internalType: 'enum MarSwapLottery.Status',
            name: 'status',
            type: 'uint8',
          },
          {
        ...
        internalType: 'struct MarSwapLottery.Lottery',
        name: '',
        type: 'tuple',
      },
    ],
