          ...
          if (personal === 1 && account) {
            if (eventsWith[i].args[0] === account) {
              if (eventsWith[i].args[9]) {
                ...
                (!eventsWith[i].args[8] &&
                  !eventsWith[i].args[9] &&
                  new BigNumber(eventsWith[i].args[6].toString()).gt(new BigNumber(eventsWith[i].args[7].toString())) &&
                  eventsWith[i].args[4].length > 1)
              ) {
                e.push(eventsWith[i].args)
                l += 1
