        ...
        {multipliers === undefined ? (
          ...
          <>
            <Text>
              ...
              <br />
              D6: {new BigNumber(multipliers.diceCall6M.toString()).div(100).toString()} Times your Bet.
              <br />
              D12: {new BigNumber(multipliers.diceCall12M.toString()).div(100).toString()} Times your Bet.
              <br />
              D20: {new BigNumber(multipliers.diceCall20M.toString()).div(100).toString()} Times your Bet.
              <br />
              <br />
