...
const Countdown: React.FC<CountdownProps> = ({ nextEventTime, preCountdownText, postCountdownText, lotteryToken }) => {
  const secondsRemaining = useNextEventCountdown(nextEventTime, lotteryToken)
