 ...
 */
const getBackground = ({ isActive, isSuccess, isWarning, borderBackground, theme }: StyledCardProps) => {
  if (borderBackground) {
  ...
  if (isActive) {
    return `linear-gradient(180deg, ${theme.colors.primary}, ${theme.colors.secondary})`
  }
