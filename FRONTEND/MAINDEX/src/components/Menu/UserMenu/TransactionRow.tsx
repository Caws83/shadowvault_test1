...
import { BlockIcon, CheckmarkCircleIcon, Flex, Link, OpenNewIcon, RefreshIcon } from 'uikit'
...
const renderIcon = (txn: TransactionDetails) => {
  ...
  return txn.receipt?.status === 'success' || typeof txn.receipt?.status === 'undefined' ? (
