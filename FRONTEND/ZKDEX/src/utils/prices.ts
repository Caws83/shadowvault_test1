...
export function computeTradePriceBreakdown(
  ...
  const BASE_FEE = new Percent(JSBI.BigInt(10000 - dex.info.numerator), JSBI.BigInt(10000))
  ...
  const realizedLPFeeAmount =
    ...
    (trade.inputAmount instanceof TokenAmount
      ...
      : CurrencyAmount.ether(realizedLPFee.multiply(trade.inputAmount.raw).quotient), dex.chainId)
