...
export const getTokenUriData = async (nftAddress: `0x${string}`, tokenId: bigint) => {
  try {
...
export const getNftByTokenId = async (nftAddress: `0x${string}`, tokenId: bigint): Promise<Nft | null> => {
