...
const AllHistoryCard: React.FC<{ lotteryToken: Token; lottoPrice: BigNumber }> = (props) => {
  ...
  useEffect(() => {
    ...
    const fetchLotteryData = async () => {
      const lotteryData = await fetchLottery(lotteryToken, selectedRoundId, chainId)
  ...
  }, [selectedRoundId, currentLotteryId, numRoundsFetched, dispatch, lotteryToken])
