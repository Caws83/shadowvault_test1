...
const CheckPrizesSection: React.FC<{ lotteryToken: Token; lottoPrice: BigNumber }> = (props) => {
  ...
  const { fetchAllRewards, unclaimedRewards, fetchStatus } = useGetUnclaimedRewards(lotteryToken)
  ...
  const [onPresentClaimModal] = useModal(
    <ClaimPrizesModal roundsToClaim={unclaimedRewards} lotteryToken={lotteryToken} lottoPrice={lottoPrice} />,
    false,
  )
  ...
  }, [unclaimedRewards, hasCheckedForRewards, fetchStatus, onPresentClaimModal, lotteryToken])
