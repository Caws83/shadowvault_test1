...
export const useLottoPrice = (lotteryToken: Token, dex: Dex) => {
  // const lotteryFarmId = useLotteryFarmId(lotteryToken)
  // const price = useBusdPriceFromId(lotteryFarmId)
  const price = useGetTokenPrice(dex, lotteryToken)
  return price
}
...
export const processLotteryResponse = (
  ...
  const discountDivisor = discountDivisorAsString
  const priceTicketInCake = priceTicketInCakeAsString
  const amountCollectedInCake = amountCollectedInCakeAsString
