    ...
    <>
      ...
      <ExpandedWrapper flexDirection="column">
        ...
        {multipliers === undefined ? (
          ...
          <>
            <Text>
              Higher: Win! {new BigNumber(multipliers.deckCutM.toString()).div(100).toString()} Times your Bet.
              <br />
              <br />
              Same: Tied! No PayOuts.
              <br />
              <br />
        ...
        <Text color="failure">Lower: You lose your bet.</Text>
        <br />
