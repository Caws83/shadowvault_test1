...
contract CakeVault is Ownable, Pausable {
    ...
    uint256 public constant MAX_WITHDRAW_FEE_PERIOD = 800 hours; // 3 days
    uint256 MAX_INT = 2**256 - 1;
    uint256 public performanceFee = 300; // 2%
    uint256 public callFee = 100; // 0.25%
    uint256 public withdrawFee = 500; // 0.1%
    uint256 public withdrawFeePeriod = 200 hours; // 3 days
    ...
    constructor(
        ...
        // Infinite approve
       IERC20(_token).approve(address(_masterchef), MAX_INT);
    }
