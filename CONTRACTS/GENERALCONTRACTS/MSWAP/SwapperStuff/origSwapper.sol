...
contract tokenSwapper is ReentrancyGuard {
    ...
    address constant ETH =  0xC76F4c819D820369Fb2d7C1531aB3Bb18e6fE8d8;
    address constant token= 0xABbAF2746C46f8F269e0a252285ABE9d8D8CDf63 ; // 
    event TransferOwnership(address oldOwner,address newOwner);
    event BoughtWithBnb(address);
    constructor () {
        owner=msg.sender;
        router = IPancakeRouter02(0x59D4dDaB6a1d9A0A84e3f8C06a720dE2404AA58a );
    }
    ...
    function TeamWithdrawStrandedToken(address strandedToken) public {
        require(msg.sender==owner);
        IBEP20 sToken=IBEP20(strandedToken);
        sToken.transfer(msg.sender, sToken.balanceOf(address(this)));
    }
