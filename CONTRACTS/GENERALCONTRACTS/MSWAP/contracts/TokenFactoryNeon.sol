...
contract MainTokenFactory is Ownable {
    ...
    constructor(address _marsFactory, uint256 _createFee) {
    ...
    function createToken(
        ...
        require(payable(treasury).send(createFee));
    ...
    function getToken(uint256 number) public view returns (MainToken){
