...
contract ERC721NFTMarketV1 is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    uint256 public defaultTradeFee = 200; // in wei
    ...
    function setDefaultTradeFee(uint256 _newFee) external onlyAdmin {
        require(_newFee <= TOTAL_MAX_FEE, "Operations: Sum of fee must inferior to TOTAL_MAX_FEE");
        defaultTradeFee = _newFee;
    }
    ...
    function addCollectionUser(
        ...
        uint256 _tradingFee = defaultTradeFee;
